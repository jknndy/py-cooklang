...
def test_extract_conditions(parser):
    ...
    expected = [{"ingredient": "egg", "condition": "cooked", "action": "proceed to the next step."}]
...
def test_extract_conditions_multiple_conditions(parser):
    ...
    expected = [
        {"ingredient": "egg", "condition": "cooked", "action": "proceed to the next step."},
